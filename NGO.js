...
function doSomething(e) {
  ...
  if (e.target.id == document.getElementsByTagName("li")[0].id) {
    ...
    document.querySelector(".hori-selector").style.setProperty("left", "916.859px");
    ...
    document.querySelector(".hori-selector").style.left = "1135.86px";
...
document.querySelector("#topnav").addEventListener("click", changecolor);
 function changecolor() {
  ...
  if (document.querySelector(".hori-selector").style.left == "916.859px") {
  ...
  if (document.querySelector(".hori-selector").style.left == "1135.86px") {
